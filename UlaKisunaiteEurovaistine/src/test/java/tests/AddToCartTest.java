...
import static units.WaitUtils.waitForListToShowUp;
...
public class AddToCartTest extends BaseTest {
   ...
   // }
    ...
    public void enterProductBrand() {
        AddToCartPage addToCartPage = new AddToCartPage(driver);
        waitForListToShowUp(driver, addToCartPage.productBrand, 5);
        ...
        driver.findElement(addToCartPage.productName).sendKeys(searchKey);
